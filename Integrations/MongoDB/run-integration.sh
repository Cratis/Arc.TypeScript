...
port=${port##*:}
ARC_MONGO_TEST_URI="mongodb://127.0.0.1:$port/?replicaSet=rs0&directConnection=true" yarn vitest run --config Integrations/MongoDB/vitest.integration.config.ts
