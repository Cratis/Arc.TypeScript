...
import { conceptCodec, dateOnlyCodec, DrizzleDialect, guidCodec, pgColumn } from '@cratis/arc.drizzle';
...
export const tasks = pgTable('tasks', {
    ...
    title: pgColumn(conceptCodec(TaskTitle, 'string', DrizzleDialect.PostgreSQL))('title').notNull(),
