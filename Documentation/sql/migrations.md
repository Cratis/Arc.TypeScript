...
Own the schema in the application and use [drizzle-kit](https://orm.drizzle.team/docs/drizzle-kit-overview) to generate and apply SQL migrations. Run migrations **before** starting Arc or admitting tenant requests. `withDrizzle` does not discover migrations, create tables or add columns at runtime.
