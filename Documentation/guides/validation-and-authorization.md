...
Named authorization policies, authentication schemes, concept validators, and validation rules shared with the client are not implemented. See the [capability reference](../reference/capabilities.md).
:::
