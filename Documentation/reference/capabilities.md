...
| OpenAPI | Supported | `/openapi.json` is OpenAPI 3.1 with input schemas, result envelopes, generated typed result schemas when metadata is registered, query options and bearer security declarations for configured authentication handlers. `info.version` can be set with `openApiVersion` (default `0.1.0`). See [OpenAPI](../open-api/index.md). | `Source/Core/for_ArcServer/when_describing_observable_query_in_openapi.ts` |
