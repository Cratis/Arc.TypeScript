...
export class a_captured_contract {
    readonly analysis = { models: [{ kind: 'model' as const, name: 'FixtureModel', namespace: 'differential.fixture.models', fields: [
        ...
        { kind: 'command' as const, name: 'CreateFixtures', owner: 'CreateFixtures', namespace: 'differential.fixture.commands',
        ...
        { kind: 'query' as const, name: 'all', owner: 'FixtureModel', namespace: 'differential.fixture.models',
            routeOverride: '/api/models/all', fields: [], roles: [], result: model },
        { kind: 'observable' as const, name: 'observe', owner: 'FixtureModel', namespace: 'differential.fixture.models',
            routeOverride: '/api/models/observe', fields: params, roles: [], result: model },
        { kind: 'query' as const, name: 'search', owner: 'FixtureModel', namespace: 'differential.fixture.models',
