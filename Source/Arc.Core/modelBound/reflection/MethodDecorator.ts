...
import type { PreparedValue } from '../commands/PreparedValue.js';
...
export type MethodDecorator<T extends readonly unknown[], AllowsPreparation extends boolean = false> = {
    <This, Arguments extends unknown[], Result>(method: (this: This, ...arguments_: Arguments) => Result,
        context: ClassMethodDecoratorContext<This, (this: This, ...arguments_: Arguments) => Result> &
            (AllowsPreparation extends true ? This extends { provide: (...arguments_: never[]) => infer Prepared } ?
                [PreparedValue<Awaited<Prepared>>, ...T] extends Arguments ? unknown : never : T extends Arguments ? unknown : never :
                T extends Arguments ? unknown : never)): void;
