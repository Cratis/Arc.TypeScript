...
// Augment its declarations with package-relative subpaths until the published package uses NodeNext exports.
declare module '@cratis/fundamentals' {
    ...
    export type { Field } from '@cratis/fundamentals/dist/esm/Field.js';
}
