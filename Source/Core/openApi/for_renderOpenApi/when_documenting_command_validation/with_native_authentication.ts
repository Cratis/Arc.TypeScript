...
describe('when documenting command validation with a native principal', given(an_operation_set, context => {
    ...
    beforeEach(() => {
        ...
        paths = renderOpenApi([command], [query], { nativePrincipal: true }).paths as typeof paths;
    });
