...
export type MethodDecorator<T extends readonly unknown[], AllowsPreparation extends boolean = false, GeneratedBinding extends boolean = false> = {
    <This, Arguments extends unknown[], Result, Name extends string>(method: (this: This, ...arguments_: Arguments) => Result,
        context: ClassMethodDecoratorContext<This, (this: This, ...arguments_: Arguments) => Result> & { name: Name } &
            (GeneratedBinding extends true ? unknown : AllowsPreparation extends true ? Name extends 'provide' ? T extends Arguments ? unknown : never :
